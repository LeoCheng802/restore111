...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Noto Sans TC', '微軟正黑體', sans-serif; scroll-behavior: smooth; }
    ...
    .product-card { background: #111; border-radius: 10px; overflow: hidden; text-align: center; transition: transform 0.4s, box-shadow 0.4s; box-shadow: 0 4px 10px rgba(255, 215, 0, 0.3); padding-bottom: 1rem; }
    .product-card:hover { transform: scale(1.05); box-shadow: 0 6px 14px rgba(255, 215, 0, 0.5); }
    .product-card img { width: 100%; height: 200px; object-fit: cover; }
    .product-card h2 { margin: 1rem 0 0.5rem 0; font-size: 1.2rem; color: #ffd700; }
    .product-card p { font-size: 0.95rem; color: #ccc; margin-bottom: 0.8rem; }
    .product-card button { background-color: #ffd700; color: #000; border: none; padding: 0.5rem 1rem; border-radius: 5px; cursor: pointer; transition: background 0.3s; }
    .product-card button:hover { background-color: #e6c200; }
    .video-section { text-align: center; padding: 2rem; background: #111; }
    .video-section h2 { color: #ffd700; margin-bottom: 1rem; }
...
<body>
  ...
  <section class="video-section">
    <h2>現場實拍影片</h2>
    <video controls>
      <source src="https://raw.githubusercontent.com/LeoCheng802/restore111/refs/heads/main/assest/videos/%E5%A4%A7%E7%89%9B%20(3).mp4" type="video/mp4">
      您的瀏覽器不支援影片播放。
    </video>
  </section>
  <footer>
