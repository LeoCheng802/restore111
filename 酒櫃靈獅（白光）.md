...
<section class="intro">
  <p>
    以酒櫃為載體，象徵圓滿、祝賀與敬獻，搭配白光靈獅，展現清淨無染、堅定守護的精神。<br>
    靈獅昂然矗立，寓意鎮煞辟邪，守護靈堂清淨安寧，同時承載深沉的思念與無盡的祝福。<br>
    純淨白光象徵著真摯與潔淨，讓追思儀式更加莊重典雅，成為場域中最莊嚴溫暖的守護力量。<br>
    ——白光靈獅，福慧同護。
  </p>
</section>
...
<section class="gallery">
  <div class="slider" id="slider">
    <div class="slides">
      <img src="/mnt/data/酒櫃靈獅 好看的圖片 (1).jpg" alt="酒櫃靈獅白光1">
      <img src="/mnt/data/酒櫃靈獅 好看的圖片 (2).jpg" alt="酒櫃靈獅白光2">
    </div>
  </div>
